export default {
  ...
  branches: [
    ...
    { name: 'Libraries',
      ...
      id: 'libraries',
      leafs: [
        { name: 'Bootstrap', ripple: 'deep-purple--text', logo: 'https://getbootstrap.com/assets/img/bootstrap-stack.png', to: '/html' },
        { name: 'Vue-Bootstrap', ripple: 'teal--text', logo: 'https://bootstrap-vue.js.org/_nuxt/img/icon.f0a8c9e.png',  to: '/html', badge: 'brands/vuejs', badgecolor: 'teal--text' },
        { name: 'Rct-Bootstrap', ripple: 'light-blue--text', logo: 'https://qph.ec.quoracdn.net/main-qimg-a1cba7ee0601b2ea0bd44d7900e23cc8',  to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },
        { name: 'NG-Bootstrap', ripple: 'blue--text', logo: 'https://ng-bootstrap.github.io/img/logo.svg', to: '/html', badge: 'brands/angular', badgecolor: 'pink--text' },

        { name: 'Semantic', ripple: 'teal--text', logo: 'https://cdn.worldvectorlogo.com/logos/semantic-ui.svg', to: '/html' },
        { name: 'Vue-Semantic', ripple: 'teal--text', logo: 'https://semantic-ui-vue.github.io/static/images/logo.png', to: '/html', badge: 'brands/vuejs', badgecolor: 'teal--text' },
        { name: 'Rct-Semantic', ripple: 'teal--text', logo: 'https://react.semantic-ui.com/logo.png', to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },
        { name: 'NG-Semantic', ripple: 'teal--text', logo: 'https://raw.githubusercontent.com/edcarroll/ng2-semantic-ui/master/demo/src/assets/logo.png', to: '/ng-semantic', badge: 'brands/angular', badgecolor: 'pink--text' },

        { name: 'Material Des...', ripple: 'grey--text', logo: 'https://cdn.dribbble.com/users/75794/screenshots/3051672/mb_social_1.gif'},
        { name: 'Material Lite', ripple: 'black--text', logo: 'https://www.3pillarglobal.com/wp-content/uploads/2015/10/mdl_logo_320x260-300x260.png', to: '/mdl' },
        { name: 'Vuetify', ripple: 'blue--text', logo: 'https://next.vuetifyjs.com/static/apple-touch-icon-180x180.png', to: '/html',  badge: 'brands/vuejs', badgecolor: 'teal--text' },
        { name: 'Vue-Material', ripple: 'light-green--text', logo: 'https://camo.githubusercontent.com/55e8a928e9fca0eeb4e7cb7836cb60dc05703c65/68747470733a2f2f7675656d6174657269616c2e696f2f6173736574732f6c6f676f2d636f6c6f722e706e67', to: '/vue-material',  badge: 'brands/vuejs', badgecolor: 'teal--text' },
        { name: 'Material UI', ripple: 'light-blue--text', logo: 'https://material-ui-next.com/static/brand.png', to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },
        { name: 'NG-Material', ripple: 'indigo--text', logo: 'http://angularexpo.com/content/images/2016/11/icon_192.png', to: '/html', badge: 'brands/angular', badgecolor: 'pink--text' },

        { name: 'Materialize', ripple: 'pink--text', logo: 'http://materializecss.com/images/favicon/apple-touch-icon-152x152.png', Materializeto: '/html' },
        { name: 'Rct-Material...', ripple: 'white-text', logo: 'https://avatars1.githubusercontent.com/u/10089934?s=280&v=4', to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },


        { name: 'Bulma', ripple: 'teal--text', logo: 'https://jgthms.com/web-design-in-4-minutes/bulma.png', to: '/bulma' },
        { name: 'Buefy', ripple: 'purple--text', logo: 'https://avatars3.githubusercontent.com/u/26799900?s=400&v=4', to: '/buefy', badge: 'brands/vuejs', badgecolor: 'teal--text' },

        { name: 'UIkit', ripple: 'blue--text', logo: 'https://pbs.twimg.com/profile_images/818852933483823104/YYr9qgV8_400x400.jpg', to: '/uikit' },
        { name: 'Vuikit', ripple: 'white--text', logo: 'https://avatars2.githubusercontent.com/u/19988804?s=400&v=4', to: '/vuikit', badge: 'brands/vuejs', badgecolor: 'teal--text' },
        { name: 'UIkit-React', ripple: 'blue--text', logo: 'https://uikit-react.io/logo.svg?v2', to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },

        { name: 'Onsen UI', ripple: 'red--text', logo: 'https://s3.amazonaws.com/media-p.slid.es/uploads/344767/images/2769652/g7.png', to: '/onsenui' },
        { name: 'Pure CSS', ripple: 'light-blue--text', logo: 'http://www.developersfeed.com/wp-content/uploads/2016/02/pure-css-logo-e1455594006843.png', to: '/pure' },
        { name: 'Element', ripple: 'light-blue--text', logo: 'http://element.eleme.io/1.4/static/banner-bg.75437e1.svg', to: '/element' },
        { name: 'Vuesax', ripple: 'purple--text', logo: 'https://madewithvuejs.com/uploads/07/11/vuesax.png', to: '/vuesax', badge: 'brands/vuejs', badgecolor: 'teal--text' },

        { name: 'Teradata', ripple: 'orange--text', logo: 'https://cdn-images-1.medium.com/max/1600/1*ZPOa0Nn_fk0XtNTmeESQzA.png', to: '/teradata', badge: 'brands/angular', badgecolor: 'pink--text' },
        { name: 'PrimeNG', ripple: 'red--text', logo: 'https://www.primefaces.org/presskit/primeng-logo.png', to: '/primeng', badge: 'brands/angular', badgecolor: 'pink--text' },
        { name: 'Clarity', ripple: 'orange--text', logo: 'https://habrastorage.org/webt/59/f0/51/59f05155beffd369502984.png', to: '/clarity', badge: 'brands/angular', badgecolor: 'pink--text' }
      ]
    },
    { name: 'Graphics',
    ...
    { name: 'Apps',
      ...
      leafs: [
        ...
        { ripple: 'teal--text', logo: 'https://avatars1.githubusercontent.com/u/32681046?s=280&v=4', name: 'NS-Vue', href: 'https://nativescript-vue.org/', badge: 'brands/vuejs', badgecolor: 'teal--text' },
    ...
    { name: 'Tools',
      ...
      id: 'tools',
      leafs: [
        { name: 'Typing', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Circle-icons-keyboard.svg/1024px-Circle-icons-keyboard.svg.png', ripple: 'orange--text',  to: '/typing' },
    ...
    { name: 'Communities',
      ...
      leafs: [
        ...
        { ripple: 'deep-orange--text', logo: 'http://www.stickpng.com/assets/images/58482e1fcef1014c0b5e4a66.png', name: 'Smashing', href: 'https://www.smashingmagazine.com/' },
        { ripple: 'orange--text', logo: 'https://foxtailmarketing.com/wp-content/uploads/2015/05/hubspot-sprocket-logo.png', name: 'HubSpot', href: 'https://www.hubspot.com/' },
        { ripple: 'lime--text', logo: 'https://d33wubrfki0l68.cloudfront.net/4e5626a0b7db6b84c0b51f1c0cfd56490fc19b74/7a5ad/images/logo-fancy.svg', name: 'Alligator', href: 'https://alligator.io' },
        { ripple: 'black--text', logo: 'http://www.stickpng.com/assets/images/58482e76cef1014c0b5e4a6c.png', name: 'SitePoint', href: 'https://sitepoint.com' },
        { ripple: 'white--text', logo: 'https://coursetro.com/images/logo-new.svg', name: 'Coursetro', href: 'https://coursetro.com' }
