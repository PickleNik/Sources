  ...
  branches: [
    { name: 'Basics',
      ...
      leafs: [
        { name: 'HTML',
          ...
          to: 'html', title: 'HTML - HyperText Markup Language',
    ...
    { name: 'Libraries',
      ...
      leafs: [
        ...
        { name: 'Material Design', ripple: 'grey--text', logo: 'https://cdn.dribbble.com/users/75794/screenshots/3051672/mb_social_1.gif'},
        ...
        { name: 'Rct-Materialize', ripple: 'white-text', logo: 'https://avatars1.githubusercontent.com/u/10089934?s=280&v=4', to: '/html', badge: 'brands/react', badgecolor: 'light-blue--text' },
