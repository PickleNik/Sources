  ...
  branches: [
    ...
    { name: 'Libraries',
      ...
      leafs: [
        ...
        { name: 'Vue-Bootstrap', ripple: 'teal--text', logo: 'https://bootstrap-vue.js.org/_nuxt/img/icon.f0a8c9e.png',  to: '/html' },
        { name: 'Rct-Bootstrap', ripple: 'light-blue--text', logo: 'https://qph.ec.quoracdn.net/main-qimg-a1cba7ee0601b2ea0bd44d7900e23cc8',  to: '/html' },
        { name: 'NG-Bootstrap', ripple: 'blue--text', logo: 'https://ng-bootstrap.github.io/img/logo.svg', to: '/html' },

        { name: 'Semantic', ripple: 'teal--text', logo: 'https://cdn.worldvectorlogo.com/logos/semantic-ui.svg', to: '/html' },
        { name: 'Vue-Semantic', ripple: 'teal--text', logo: 'https://semantic-ui-vue.github.io/static/images/logo.png', to: '/html' },
        { name: 'Rct-Semantic', ripple: 'teal--text', logo: 'https://react.semantic-ui.com/logo.png', to: '/html' },
        { name: 'NG-Semantic', ripple: 'teal--text', logo: 'https://raw.githubusercontent.com/edcarroll/ng2-semantic-ui/master/demo/src/assets/logo.png', to: '/ng-semantic' },
        ...
        { name: 'Vuetify', ripple: 'blue--text', logo: 'https://next.vuetifyjs.com/static/apple-touch-icon-180x180.png', to: '/html' },
        { name: 'Vue-Material', ripple: 'light-green--text', logo: 'https://camo.githubusercontent.com/55e8a928e9fca0eeb4e7cb7836cb60dc05703c65/68747470733a2f2f7675656d6174657269616c2e696f2f6173736574732f6c6f676f2d636f6c6f722e706e67', to: '/vue-material' },
        { name: 'Material UI', ripple: 'light-blue--text', logo: 'https://material-ui-next.com/static/brand.png', to: '/html' },
        { name: 'NG-Material', ripple: 'indigo--text', logo: 'http://angularexpo.com/content/images/2016/11/icon_192.png', to: '/html' },
        ...
        { name: 'Rct-Materialize', ripple: 'white-text', logo: 'https://avatars1.githubusercontent.com/u/10089934?s=280&v=4', to: '/html' },


        { name: 'Bulma', ripple: 'teal--text', logo: 'https://jgthms.com/web-design-in-4-minutes/bulma.png', to: '/bulma' },
        { name: 'Buefy', ripple: 'purple--text', logo: 'https://avatars3.githubusercontent.com/u/26799900?s=400&v=4', to: '/buefy' },

        { name: 'UIkit', ripple: 'blue--text', logo: 'https://pbs.twimg.com/profile_images/818852933483823104/YYr9qgV8_400x400.jpg', to: '/uikit' },
        { name: 'Vuikit', ripple: 'white--text', logo: 'https://avatars2.githubusercontent.com/u/19988804?s=400&v=4', to: '/uikit' },
        { name: 'UIkit-React', ripple: 'blue--text', logo: 'https://uikit-react.io/logo.svg?v2', to: '/html' },
        ...
        { name: 'Vuesax', ripple: 'purple--text', logo: 'https://madewithvuejs.com/uploads/07/11/vuesax.png', to: '/vuesax' },

        { name: 'Teradata', ripple: 'orange--text', logo: 'https://cdn-images-1.medium.com/max/1600/1*ZPOa0Nn_fk0XtNTmeESQzA.png', to: '/teradata' },
        { name: 'PrimeNG', ripple: 'red--text', logo: 'https://www.primefaces.org/presskit/primeng-logo.png', to: '/primeng' },
        { name: 'Clarity', ripple: 'orange--text', logo: 'https://habrastorage.org/webt/59/f0/51/59f05155beffd369502984.png', to: '/clarity' }
      ]
    },
    { name: 'Graphics',
