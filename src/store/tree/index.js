export default {
  state: {
    ...
    leafsTools: [
      { ripple: 'orange--text', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Circle-icons-keyboard.svg/1024px-Circle-icons-keyboard.svg.png', name: 'Typing', to: '/html' },
      ...
      { ripple: 'red--text', logo: 'https://d2eip9sf3oo6c2.cloudfront.net/tags/images/000/000/188/full/npmlogo.png', name: 'NPM', to: '/html' },
      { ripple: 'light-blue--text', logo: 'https://assets-cdn.github.com/images/modules/logos_page/Octocat.png', name: 'GitHub', to: '/html' },
      { ripple: 'lime--text', logo: 'http://www.lukashejtmanek.cz/assets/img/symbol_transparent.png', name: 'HackerRank', to: '/html' },
      { ripple: 'amber--text', logo: 'https://firebase.google.com/_static/images/firebase/touchicon-180.png', name: 'Firebase', to: '/firease' },
      { ripple: 'white--text', logo: 'http://blog.codepen.io/wp-content/uploads/2012/06/Button-Fill-White-Large.png', name: 'CodePen', to: '/html' },
      { ripple: 'light-green--text', logo: 'http://www.karlsjohnson.com/link/resources/images/w3school.png', name: 'Tryit Editor', to: '/html' },
      ...
      { ripple: 'amber--text', logo: 'https://i.stack.imgur.com/GKbCl.png', name: 'Stack Overflow', to: '/html' },
